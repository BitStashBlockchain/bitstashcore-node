...
module.exports.services.Bitcoin = require('./lib/services/bitstashd');
module.exports.services.BITSTASH = require('./lib/services/bitstashd');
...
module.exports.lib = require('bitstash-lib');
