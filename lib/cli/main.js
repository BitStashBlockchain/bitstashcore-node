...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitstashcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitstashcore-node add wallet-service');
      console.log('    $ bitstashcore-node add bitstash-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitstashcore-node remove wallet-service');
      console.log('    $ bitstashcore-node remove bitstash-api');
      console.log();
    });
