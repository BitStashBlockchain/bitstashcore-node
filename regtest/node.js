...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.bitstashd.height === 150) {
            node.services.bitstashd.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.bitstashd.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('bitstashd/hashblock', function(data) {
        bus.unsubscribe('bitstashd/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.bitstashd.height;
      node.services.bitstashd.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.bitstashd.sendTransaction(tx.serialize(), function(err, hash) {
